...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Metadaten>(entity =>
            {
                entity.HasKey(e => e.Surname);

                entity.ToTable("Metadaten", "Admin");
            ...
            {
                entity.ToTable("Protokoll", "Admin");

                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.Aktion).HasMaxLength(50);

                entity.Property(e => e.AlterWert).IsUnicode(false);

                entity.Property(e => e.Attribut).HasMaxLength(50);

                entity.Property(e => e.Benutzer).IsUnicode(false);

                entity.Property(e => e.Computer).IsUnicode(false);

                entity.Property(e => e.Entity).HasMaxLength(50);

                entity.Property(e => e.EntityId).HasColumnName("EntityID");

                entity.Property(e => e.NeuerWert).IsUnicode(false);
            ...
            modelBuilder.Entity<Test>(entity =>
            {
                ...
                entity.Property(e => e.Event).HasColumnType("nchar(10)");
            });
        }
    }
}
