...
namespace DA.Migrations
{
    ...
    partial class WWWingsContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("BO.Passenger", b =>
                {
                    ...
                    b.Property<string>("FrequentFlyer")
                        .HasConversion(new ValueConverter<string, bool>(v => default(bool), v => default(string)));
            ...
            modelBuilder.Entity("BO.Pilot", b =>
                {
                    ...
                    b.Property<int?>("PilotLicenseType")
                        .HasConversion(new ValueConverter<PilotLicenseType?, string>(v => default(string), v => default(PilotLicenseType?)));

                    b.Property<int>("PilotLicenseType2");
